...
# Filters for 2010-current correlations!
OutsideData <- OutsideData %>%
  filter(Date >= 2011)
LumberData <- LumberData %>%
  filter(Date >= 2011)
...
sd_df <- data.frame(MiniPredictor1 = 1/sd(CESData$Expenditures_MajorAppliancesbySizeofConsumerUnit_TwoPeopleinConsumerUnit),
                    MiniPredictor2 = 1/sd(CESData$`Expenditures_FurniturebyQuintilesofIncomeBeforeTaxes_Third20Percent(41stto60thPercentile)`),
                    MiniPredictor3 = 1/sd(CESData$`Expenditures_SmallAppliances_MiscellaneousHousewaresbyQuintilesofIncomeBeforeTaxes_Second20Percent(21stto40thPercentile)`),

                    SmallPredictor1 = 1/sd(CESData$`Expenditures_MajorAppliancesbyQuintilesofIncomeBeforeTaxes_Fourth20Percent(61stto80thPercentile)`),
                    SmallPredictor2 = 1/sd(CESData$`Expenditures_FurniturebyQuintilesofIncomeBeforeTaxes_Third20Percent(41stto60thPercentile)`),

                    MediumPredictor1 = 1/sd(CESData$Expenditures_MajorAppliancesbySizeofConsumerUnit_FiveorMorePeopleinConsumerUnit),
                    MediumPredictor2 = 1/sd(CESData$`Expenditures_FurniturebyQuintilesofIncomeBeforeTaxes_Highest20Percent(81stto100thPercentile)`),
                    MediumPredictor3 = 1/sd(CESData$`Expenditures_FurniturebyQuintilesofIncomeBeforeTaxes_Third20Percent(41stto60thPercentile)`),
                    MediumPredictor4 = 1/sd(CESData$`Expenditures_MajorAppliancesbyQuintilesofIncomeBeforeTaxes_Highest20Percent(81stto100thPercentile)`),

                    LargePredictor1 = 1/sd(CESData$`Expenditures_FurniturebyQuintilesofIncomeBeforeTaxes_Fourth20Percent(61stto80thPercentile)`),
                    LargePredictor2 = 1/sd(OutsideData$BuildingMaterialsandSuppliesDealers),

                    PrecipPredictor1 = 1/sd(NEPrecipDiff$AMJ),
                    PrecipPredictor2 = 1/sd(OutsideData$GasolineStations))
sd_df <- sd_df %>%
  pivot_longer(cols = 1:13) %>%
  rename(`1/sd` = value)

cor_df <- data.frame(MiniPredictor1 = Correlations[Correlations$Variable == 'Expenditures_MajorAppliancesbySizeofConsumerUnit_TwoPeopleinConsumerUnit',]$Mini,
                     MiniPredictor2 = Correlations[Correlations$Variable == 'Expenditures_FurniturebyQuintilesofIncomeBeforeTaxes_Third20Percent(41stto60thPercentile)',]$Mini,
                     MiniPredictor3 = Correlations[Correlations$Variable == 'Expenditures_SmallAppliances_MiscellaneousHousewaresbyQuintilesofIncomeBeforeTaxes_Second20Percent(21stto40thPercentile)',]$Mini,

                     SmallPredictor1 = Correlations[Correlations$Variable == 'Expenditures_MajorAppliancesbyQuintilesofIncomeBeforeTaxes_Fourth20Percent(61stto80thPercentile)',]$Small,
                     SmallPredictor2 = Correlations[Correlations$Variable == 'Expenditures_FurniturebyQuintilesofIncomeBeforeTaxes_Third20Percent(41stto60thPercentile)',]$Small,

                     MediumPredictor1 = Correlations[Correlations$Variable == 'Expenditures_MajorAppliancesbySizeofConsumerUnit_FiveorMorePeopleinConsumerUnit',]$Medium,
                     MediumPredictor2 = Correlations[Correlations$Variable == 'Expenditures_FurniturebyQuintilesofIncomeBeforeTaxes_Highest20Percent(81stto100thPercentile)',]$Medium,
                     MediumPredictor3 = Correlations[Correlations$Variable == 'Expenditures_FurniturebyQuintilesofIncomeBeforeTaxes_Third20Percent(41stto60thPercentile)',]$Medium,
                     MediumPredictor4 = Correlations[Correlations$Variable == 'Expenditures_MajorAppliancesbyQuintilesofIncomeBeforeTaxes_Highest20Percent(81stto100thPercentile)',]$Medium,

                     LargePredictor1 = Correlations[Correlations$Variable == 'Expenditures_FurniturebyQuintilesofIncomeBeforeTaxes_Fourth20Percent(61stto80thPercentile)',]$Large,
                     LargePredictor2 = Correlations[Correlations$Variable == 'BuildingMaterialsandSuppliesDealers',]$Large,

                     PrecipPredictor1 = Correlations[Correlations$Variable == 'AMJ_CR_NEUS',]$DisRepair,
...
PredProps$Variable <- c('Expenditures_MajorAppliancesbySizeofConsumerUnit_TwoPeopleinConsumerUnit',
                        'Expenditures_FurniturebyQuintilesofIncomeBeforeTaxes_Third20Percent(41stto60thPercentile)',
                        'Expenditures_SmallAppliances_MiscellaneousHousewaresbyQuintilesofIncomeBeforeTaxes_Second20Percent(21stto40thPercentile)',

                        'Expenditures_MajorAppliancesbyQuintilesofIncomeBeforeTaxes_Fourth20Percent(61stto80thPercentile)',
                        'Expenditures_FurniturebyQuintilesofIncomeBeforeTaxes_Third20Percent(41stto60thPercentile)',

                        'Expenditures_MajorAppliancesbySizeofConsumerUnit_FiveorMorePeopleinConsumerUnit',
                        'Expenditures_FurniturebyQuintilesofIncomeBeforeTaxes_Highest20Percent(81stto100thPercentile)',
                        'Expenditures_FurniturebyQuintilesofIncomeBeforeTaxes_Third20Percent(41stto60thPercentile)',
                        'Expenditures_MajorAppliancesbyQuintilesofIncomeBeforeTaxes_Highest20Percent(81stto100thPercentile)',

                        'Expenditures_FurniturebyQuintilesofIncomeBeforeTaxes_Fourth20Percent(61stto80thPercentile)',
...
write.xlsx(dataset_list, "C:/Users/ikennedy/JBREC/BP research public use microdata coding and data - General/AHSProject/OutsideDataSources_SingleYearApprox/AllCorrelations_2010_Current.xlsx")
