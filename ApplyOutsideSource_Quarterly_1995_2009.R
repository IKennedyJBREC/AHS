...
OutsideData <- OutsideData %>%
  mutate(MiniPredictor1 = Roofing_RR,
         MiniPredictor2 = Doors_RR,
         MiniPredictor3 = Insulation_RR,

         SmallPredictor1 = Concrete_RR,
         SmallPredictor2 = Dimensional_Lumber_RR,
         SmallPredictor3 = Windows_RR,
         SmallPredictor4 = Furniture_HomeFurnishings_Electronics_andApplianceStores,
         SmallPredictor5 = HVAC_Total,
         SmallPredictor6 = Roofing_RR,
         SmallPredictor7 = Insulation_RR,

         MediumPredictor1 = Concrete_RR,
         MediumPredictor2 = HVAC_Total,
         MediumPredictor3 = Furniture_HomeFurnishings_Electronics_andApplianceStores,
         MediumPredictor4 = Windows_RR,
         MediumPredictor5 = Dimensional_Lumber_RR,
         MediumPredictor6 = Roofing_RR,

         LargePredictor1 = HVAC_Total,
         LargePredictor2 = Dimensional_Lumber_RR,
         LargePredictor3 = Sheathing_Total,
         LargePredictor4 = Countertops_Total,
         LargePredictor5 = Drywall_Wallboard_Total,
         LargePredictor6 = Furniture_HomeFurnishings_Electronics_andApplianceStores,
         LargePredictor7 = Windows_RR,

         PrecipPredictor1 = RoofResPermitCount,
         PrecipPredictor2 = GasolineStations)
...
PredProps <- read.xlsx("C:/Users/ikennedy/JBREC/BP research public use microdata coding and data - General/AHSProject/OutsideDataSources_SingleYearApprox/AllCorrelations_Quarterly_1998_2009.xlsx", sheet = 2)
PredProps <- PredProps %>%
...
SmallPredictor7_Mult <- PredProps[PredProps$name == 'SmallPredictor7',]$FinalProp
...
for (i in 1:length(OutsideData$Date)){
  ...
  if (str_detect(OutsideData$Date[i], pattern = '1$')){
    ...
    Template$Small[i] <-  ((OutsideData$Small[i] * (OutsideData$SmallPredictor1[i] / (OutsideData$SmallPredictor1[i] + OutsideData$SmallPredictor1[i+1] + OutsideData$SmallPredictor1[i+2] + OutsideData$SmallPredictor1[i+3]))) * SmallPredictor1_Mult) +
                          ...
                          ((OutsideData$Small[i] * (OutsideData$SmallPredictor7[i] / (OutsideData$SmallPredictor7[i] + OutsideData$SmallPredictor7[i+1] + OutsideData$SmallPredictor7[i+2] + OutsideData$SmallPredictor7[i+3]))) * SmallPredictor7_Mult)
    ...
    Template$Small[i] <- ((OutsideData$Small[i] * (OutsideData$SmallPredictor1[i] / (OutsideData$SmallPredictor1[i] + OutsideData$SmallPredictor1[i-1] + OutsideData$SmallPredictor1[i+1] + OutsideData$SmallPredictor1[i+2]))) * SmallPredictor1_Mult) +
                         ...
                         ((OutsideData$Small[i] * (OutsideData$SmallPredictor7[i] / (OutsideData$SmallPredictor7[i] + OutsideData$SmallPredictor7[i-1] + OutsideData$SmallPredictor7[i+1] + OutsideData$SmallPredictor7[i+2]))) * SmallPredictor7_Mult)
    ...
    Template$Small[i] <- ((OutsideData$Small[i] * (OutsideData$SmallPredictor1[i] / (OutsideData$SmallPredictor1[i] + OutsideData$SmallPredictor1[i-2] + OutsideData$SmallPredictor1[i-1] + OutsideData$SmallPredictor1[i+1]))) * SmallPredictor1_Mult) +
                         ...
                         ((OutsideData$Small[i] * (OutsideData$SmallPredictor7[i] / (OutsideData$SmallPredictor7[i] + OutsideData$SmallPredictor7[i-2] + OutsideData$SmallPredictor7[i-1] + OutsideData$SmallPredictor7[i+1]))) * SmallPredictor7_Mult)
    ...
    Template$Small[i] <- ((OutsideData$Small[i] * (OutsideData$SmallPredictor1[i] / (OutsideData$SmallPredictor1[i] + OutsideData$SmallPredictor1[i-3] + OutsideData$SmallPredictor1[i-2] + OutsideData$SmallPredictor1[i-1]))) * SmallPredictor1_Mult) +
                         ...
                         ((OutsideData$Small[i] * (OutsideData$SmallPredictor7[i] / (OutsideData$SmallPredictor7[i] + OutsideData$SmallPredictor7[i-3] + OutsideData$SmallPredictor7[i-2] + OutsideData$SmallPredictor7[i-1]))) * SmallPredictor7_Mult)
...
Template_2010_Current <- read.xlsx("C:/Users/ikennedy/JBREC/BP research public use microdata coding and data - General/AHSProject/AHSSummaries/QuarterlyApprox_2010_Current.xlsx")
Template_2010_Current$Date <- as.yearqtr(Template_2010_Current$Date)
FinalTemplate <- Template %>%
  rbind(Template_2010_Current)
...
YearlyTotals <-FinalTemplate %>%
  group_by(Year) %>%
  summarize(All = sum(TotalJobCost))

YearlyTotals_BySize <-FinalTemplate %>%
  group_by(Year, CostClass) %>%
  summarize(Spend = sum(TotalJobCost))


write.xlsx(Template, "C:/Users/ikennedy/JBREC/BP research public use microdata coding and data - General/AHSProject/AHSSummaries/QuarterlyApprox_2000_2009.xlsx")
write.xlsx(FinalTemplate, "C:/Users/ikennedy/JBREC/BP research public use microdata coding and data - General/AHSProject/AHSSummaries/QuarterlyApprox.xlsx")
